package com.tavares.kaique.githubapp
...
import com.tavares.kaique.githubapp.api.GitHubService
import com.tavares.kaique.githubapp.model.Usuario
                    ...
                    .enqueue(object :Callback<Usuario>{
                        override fun onFailure(call: Call<Usuario>?, t: Throwable?) {
                            Toast.makeText(this@GitHubActivity,
                                    "XIIIIII deu ruim",Toast.LENGTH_LONG).show()
                        }
